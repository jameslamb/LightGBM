...
#pragma omp parallel for schedule(static, 512) num_threads(OMP_NUM_THREADS()) if (len >= 1024)
...
#pragma omp parallel for schedule(static, 512) num_threads(OMP_NUM_THREADS()) if (out_len >= 1024)
...
#pragma omp parallel for schedule(static, 512) num_threads(OMP_NUM_THREADS()) if (int_len >= 1024)
