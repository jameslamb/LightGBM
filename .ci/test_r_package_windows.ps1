...
$env:PATH = "$RTOOLS_INSTALL_PATH\bin;" + "$RTOOLS_INSTALL_PATH\usr\bin;" + "$RTOOLS_INSTALL_PATH\mingw_64\bin;" + "$env:R_LIB_PATH/R/bin/x64;" + "$env:R_LIB_PATH/miktex/texmfs/install/miktex/bin/x64;" + $env:PATH
