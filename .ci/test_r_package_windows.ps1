...
$packages = "c('data.table', 'jsonlite', 'Matrix', 'processx', 'R6', 'testthat', 'tinytex'), dependencies = c('Imports', 'Depends', 'LinkingTo')"
...
Run-R-Code-Redirect-Stderr "tinytex::install_tinytex()" ; Check-Output $?
